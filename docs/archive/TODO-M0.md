...
> 归档说明（2026-09-20，执行：ZCode（GLM））：本文档为项目最早期（独立建仓、脱离 QQ、搭 Web 对话链路阶段）的开发待办，全部条目早已完成或被后续路线取代；且文中仓库路径仍为 `D:\DSH\TZtuzhanAssistant`（现已迁移至 `D:\TZtuzhanAssistant`）。归档仅作历史留痕，勿据此排期。当前全项目状态见 `docs/WORKTREE-2026-09-20.md`。
